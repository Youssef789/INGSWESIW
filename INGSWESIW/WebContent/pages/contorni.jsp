		...
		<div class="row">
			...
			<div class="col-xs-9" id="right">
				<section class="recipe">
        		 	...
        		 	<c:forEach var="contorno" items="${contorni}">
        		 	<ul class="recipe-showcase">
        		 		<li>
        		 		<figure class="recipe-photo">
        		 		<a href="GetRecipe?idRecipe=${recipe.id}"><img src="image/image/${contorno.imageName}" width="214" height="138"></a>
        		 		
        		 		<a href="GetRecipe?idRecipe=${recipe.id}" id="title">${contorno.title}</a>
        		 		<a href="GetRecipe?idRecipe=${recipe.id}" id="category">${contorno.category}</a>  
        		 		<a href="" id="star">****</a>  
        		 		</figure>
