...
public class CommentoDaoJDBC implements CommentoDao {
	...
	public void update(Commento commento) {
		Connection connection = this.dataSource.getConnection();
		try {
			String update = "update commento set dataUltimaModifica = ?, contenuto = ? where id = ?";
	...
	public Set<Commento> findAll() {
		Connection connection = this.dataSource.getConnection();
		Set<Commento> commenti = new LinkedHashSet<Commento>();
		try {
	...
	@Override
	public Set<Commento> findByRicetta(Ricetta ricetta) {
		Connection connection = this.dataSource.getConnection();
		Set<Commento> commenti = new LinkedHashSet<Commento>();
		try {
			Commento commento = null;
	...
	@Override
	public Set<Commento> findByUtente(Utente utente) {
		Connection connection = this.dataSource.getConnection();
		Set<Commento> commenti = new LinkedHashSet<Commento>();
		try {
			Commento commento = null;
