	...
	public void createDatabase() {
		...
		try {
			String create = /* sequences */
					        ...
					        "create TABLE utente (username VARCHAR(255) primary key not null, email VARCHAR(255) not null unique, password VARCHAR(255) not null, immagineProfilo VARCHAR(255) unique);" +
