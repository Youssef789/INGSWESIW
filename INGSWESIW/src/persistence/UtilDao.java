	...
	public void createDatabase() {
		...
		try {
			String create = /* sequences */
	        			    ...
	        			    "create table immagineProfilo (immagine_nome text primary key not null, immagine bytea not null, utente_username VARCHAR(255) references utente (username) on delete cascade not null);";
	...
	public void dropDatabase() {		
		...
		try {
			String drop = "drop sequence if exists sequenza_id_ricetta;" +
					      ...
					      "drop table if exists immagineProfilo;" +
